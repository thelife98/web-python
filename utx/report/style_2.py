...
<div class="wrapper wrapper-content animated fadeInRight">
    <div id="error_case" class="alert alert-danger" role="alert">测试结果里边有报错的用例，请优先处理！</div>
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="input-group panel-heading"
                        ...
                        <select class="chosen-select form-control" data-placeholder="----------" style="width: 300px;"
                                name="filterClass" id="filterClass">
                            <option value="">----------</option>
                        </select>
                        <label style="color: snow;width: 40px"></label>
                        <label style="color: snow">只看:</label>
                        <select class="chosen-select form-control" data-placeholder="----------" style="width: 150px;"
...
<script type="text/javascript">
    ...
    $(function () {
            ...
            $.each(resultData["testResult"], function (i, n) {
                if ((className === "" || n["className"] === className) && (caseResult === "" || n["status"] === caseResult)) {
                    ...
                    if (n["status"] === '成功') {
                        ...
                        status = "<td><span class='text-danger'>" + n["status"] + "！！！</span></td>";
                        error_case_flag = true;
                    }
                    var tr = "<tr style='font-family: Consolas,serif'>" +
                        "<td>" + (i + 1) + "</td>" +
                        "<td>" + n["className"] + "</td>" +
                        "<td>" + n["methodName"] + "</td>" +
                        "<td>" + n["description"] + "</td>" +
                    ...
                    if (n["log"]) {
                        ...
                        tr = tr + "<td><button type='button' onclick='details(this)' buttonIndex='" + i + "' class='btn btn-primary btn-xs' style='margin-bottom: 0px'>展开</button></td></tr>";
                    }
                    else {
                        tr = tr + "<td></td>";
                    }
        ...
        function pie() {
            var option = {
                color: ['#c23531', '#5F6564', '#1ab394', '#d48265', '#91c7ae', '#749f83', '#ca8622', '#bda29a', '#6e7074', '#546570', '#c4ccd3'],
