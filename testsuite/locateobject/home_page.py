...
class HomePage(BasePage):
    ...
    def user_1(self, text):
        ...
        self.type("xpath=>.//*[@id='pane-userLogin']/form/div[1]/div/div/input", text)

    # 密码
    def password_1(self, text):
        #self.type("xpath=>.//*[@id='password']", text)
        self.type("xpath=>.//*[@id='pane-userLogin']/form/div[2]/div/div/input", text)
    ...
    # 物流账册
    def menu_1(self):
        self.click("xpath=>.//*[@id='side-menu']/div[3]/ul/li[1]/a/span[1]")
        self.sleep(3)

    # 物流账册申报
    def submenu_1(self):
        self.click("xpath=>.//*[@id='side-menu']/div[3]/ul/li[1]/ul/li[1]/a")
        self.sleep(2)
